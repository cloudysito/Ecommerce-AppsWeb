                    ...
                    <div class="confirmacion-container">
                        ...
                        <div class="confirmacion-detalles">
                            ...
                            <div class="detalle-item">
                                ...
                                <p class="detalle-valor">
                                    <c:choose>
                                        <c:when test="${sessionScope.ultimaCompraMetodoPago == 'tarjeta'}">💳 Tarjeta</c:when>
                                        <c:when test="${sessionScope.ultimaCompraMetodoPago == 'transferencia'}">🏦 Transferencia Bancaria</c:when>
                                        <c:when test="${sessionScope.ultimaCompraMetodoPago == 'contraEntrega'}">📦 Contra Entrega</c:when>
