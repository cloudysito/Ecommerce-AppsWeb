                ...
                <div class="contenedor-registro">
                    <div class="tarjeta-registro">
                        ...
                        <c:if test="${not empty requestScope.error}">
                            <div class="error-message" style="color: white; background: #e74c3c; padding: 10px; text-align: center; border-radius: 5px; margin-bottom: 15px;">
                                ${requestScope.error}
                            </div>
                        </c:if>

                        <form id="formRegistro" class="formulario-registro" action="${pageContext.request.contextPath}/UsuarioServlet" method="POST">
                            ...
                            <div class="grid-formularios">
                                ...
                                <div class="grupo-formulario">
                                    ...
                                    <input type="password" id="contrasenia" name="contrasenia" placeholder="••••••••" required minlength="8" title="La contraseña debe tener al menos 8 caracteres.">
                                </div>

                                <div class="grupo-formulario">
                                    <label for="confirmar_contrasenia">Confirmación de contraseña</label>
                                    <input type="password" id="confirmar_contrasenia" name="confirmar_contrasenia" placeholder="••••••••" required minlength="8">
                                </div>
                                ...
                                <div class="grupo-formulario">
                                    ...
                                    <input type="tel" id="telefono" name="telefono" placeholder="1234567890" required
                                           ...
                                           title="Ingresa un número de teléfono válido de al menos 10 dígitos."
                            ...
                            <div class="grupo-formulario">
                                ...
                                <textarea id="direccion" rows="4" name="direccion" placeholder="Av. Universidad 123, Depto 4B, Ciudad, Estado, CP" required minlength="10" title="Proporciona una dirección detallada."></textarea>
                            </div>
